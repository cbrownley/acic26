...
# Strategy for combining the 4 ensemble members
# "VARIANCE": Inverse-variance weighting (Legacy)
# "RLOSS": Non-negative least squares optimization of the Robinson Loss (Alternative 1)
ENSEMBLE_STRATEGY = "RLOSS"
...
# ── Bootstrap / inference ─────────────────────────────────────────────────────
# SET TO FALSE: This drops the N_BOOT=50 refits (saving ~80% of run time).
# DRLearner will contribute its point estimate via R-Loss weights, while
# CIs will be derived from LinearDRL, CausalForest, and ForestDRL.
USE_BOOTSTRAP = False
